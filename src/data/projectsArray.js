...
export const projectsArray = [
    ...
    },
    {
        id: 3,
        name: 'ToDo app',
        info: 'App provides ToDo list, where you can create/check/delete tasks. Contains tasks stats and settings.',
        stack: 'React, Material UI, SCSS, Adaptive and responsive layout',
